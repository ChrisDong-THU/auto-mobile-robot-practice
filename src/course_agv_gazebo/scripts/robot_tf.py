...
class GazeboLinkPose:
    ...
    def callback(self, data):
        '''
        订阅gazebo的信息发布, 读取关节位置信息到self.link_pose
        '''
        try:
    ...
    def publish_tf(self):
        ...
        # sendTransform((translation), (rotation), rospy.Time.now(), child_frame, parent_frame)
        # child_frame：子坐标系的名称，parent_frame：父坐标系的名称
